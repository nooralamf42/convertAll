            ...
            <div className={styles.navLinkDropdown}>
                ...
                <div className={styles.navRelative} style={isActive==true?{"display":"block"}:{"display":"none"}}>
                    <div className={styles.navLinksBox}>
                        <Link className={styles.navLinks} onClick={()=> setIsActive(false)} to={"/length"}>Length</Link>
                        <Link className={styles.navLinks} onClick={()=> setIsActive(false)} to={"/mass"}>Mass</Link>
                        <Link className={styles.navLinks} onClick={()=> setIsActive(false)} to={"/time"}>Time</Link>
                        <Link className={styles.navLinks} onClick={()=> setIsActive(false)} to={"/currency"}>Currency</Link>
                        <Link className={styles.navLinks} onClick={()=> setIsActive(false)} to={"/data"}>Data</Link> 
                    </div>
                </div>
            </div>
        </nav>
